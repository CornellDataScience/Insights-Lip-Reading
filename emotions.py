...
# modelVGG16.add(Conv2D(64, kernel_size=(3, 3),
#                  activation='relu', input_shape=(48, 48, 1)))
# modelVGG16.add(Conv2D(64, kernel_size=(3, 3), activation='relu'))
# model.add(MaxPooling2D(pool_size=(2, 2)))
# modelVGG16.add(Conv2D(128, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(Conv2D(128, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(MaxPooling2D(pool_size=(2, 2)))
# modelVGG16.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(MaxPooling2D(pool_size=(2, 2)))
# modelVGG16.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
# modelVGG16.add(MaxPooling2D(pool_size=(2, 2)))
# modelVGG16.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
...
# modelVGG16.add(Dense(4096, activation='relu'))
# modelVGG16.add(Dense(1000, activation='relu'))
# modelVGG16.add(Dense(7, activation='softmax'))
